...
function putInArticle(data) {
    ...
    $(".hao-session-center").empty();
    var artiles = $(".hao-session-center");
    $.each(data, function (index, obj) {
        var center = $(
            '<div class="hao-center">' +
            '<header class="hao-article">' +
            '<h1 itemprop="name">' +
            '<a class="hao-article-title" href="' + obj['articleUrl'] + '">' + obj['title'] + '</a>' +
            '</h1>' +
            '<div class="hao-tt">' +
            '<span class="am-badge am-badge-success hao-mark">' + obj['selectType'] + '</span>&nbsp;&nbsp;' +
