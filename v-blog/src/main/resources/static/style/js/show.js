...
function putInArticleDetail(data) {
    $(".hao-article-top").html('');
    var center = $(
        '<div class="hao-article-top">' +
        '<div class="article-top">' + data.title + '</div>' +
        '<div class="hao-tt article-info">' +
        '<span class="am-badge am-badge-success hao-mark">&nbsp;' + data.selectType + '</span>&nbsp;&nbsp;' +
